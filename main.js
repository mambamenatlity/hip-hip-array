...
for(let i = grades.length - 1; i >=0; i >=0; i = i - 1 {
...
challenged8.push(2);
challenged8.push(3);
challenged8.unshift(4);
challenged8.unshift(5);

for (let i = 0; i < challenged8.length; i++) {
  const value = challenged8[i];
  console.log(value);
}
// Challenge 9
...
const studentsSlice = studetns.slice();
...
const thrird = primaries.contact(secondaries); 
  for (let i = 0; i < thrird.length; i++) {
  const value = third[i];
console.log(value);
}
